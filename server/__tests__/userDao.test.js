...
describe("getUser", ()=>{
    ...
    test("user exists", ()=>{
        ...
        return userDao.getUser("john@poltesto.test")
            .then(user=>expect(user.userID).toEqual('275330'));
    });
...
describe("checkPassword", ()=>{
    ...
    test("password ok", ()=>{
        const user = new User("275330", "John test", "john@poltesto.test", "$2b$12$7iALJ38k/PBlAB7b8JDksu7v85z.tjnC9XfoMdUJd75bIId87Ip2S", 1);
